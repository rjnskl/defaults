(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ! function() {
            ...
            var sa = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Un);
    ...
    2: [function(require, module, exports) {
        ! function(n, r) {
            "object" == typeof exports && "undefined" != typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define("queue", r) : n.queue = r()
        }(this, function() {
            "use strict";
            ...
            function r(r) {
                    ...
                    if (!a)
                        for (; a = d && r > s;) {
                            var n = v + s,
                                ...
                                o = t.length - 1,
                                e = t[o];
                            t[o] = f(n), --d, ++s, p[n] = e.apply(null, t) || u
                        }
                }

                function f(n) {
                    return function(r, o) {
                        if (!p[n]) throw new Error;
                        --s, ++v, p[n] = null, null == w && (null != r ? i(r) : (h[n] = o, d ? t() : s || l()))
                    }
                }
                ...
                function l() {
                    null != w ? E(w) : b ? E(null, h) : E.apply(null, e.concat(h))
                }
                ...
                return c = {
                    defer: function(r) {
                        ...
                        return u.push(r), ++d, p.push(u), t(), c
                    },
                    abort: function() {
                        if (null == w) {
                            for (var n, r = v + s; --r >= 0;)(n = p[r]) && n.abort && n.abort();
                            i(new Error("abort"))
                        }
                        return c
                    },
                    await: function(r) {
                        if (E !== n) throw new Error;
                        return E = r, b = !1, d || s || l(), c
                    },
                    awaitAll: function(r) {
                        if (E !== n) throw new Error;
                        return E = r, b = !0, d || s || l(), c
                    }
                }
            }

            function t(n) {
                return r(arguments.length ? +n : 1 / 0)
            }
            var o = [].slice,
                u = {},
                e = [null];
            return t.version = "1.2.1", t
        });
    }, {}],
    3: [function(require, module, exports) {
        (function() {
            ...
            m.groupBy = F(function(n, t, r) {
                ...
                return null != n ? null == t || r ? n[0] : m.initial(n, n.length - t) : void 0
            }, m.initial = function(n, t, r) {
                return l.call(n, 0, Math.max(0, n.length - (null == t || r ? 1 : t)))
            }, m.last = function(n, t, r) {
                return null != n ? null == t || r ? n[n.length - 1] : m.rest(n, Math.max(0, n.length - t)) : void 0
                ...
                for (var r in t) {
                    ...
                    for (var l in this.waypoints[r]) {
                        var a, h, p, u, c, f = this.waypoints[r][l],
                            ...
                            w = 0,
                            g = null == y;
                        f.element !== f.element.window && (w = f.adapter.offset()[s.offsetProp]), "function" == typeof d ? d = d.apply(f) : "string" == typeof d && (d = parseFloat(d), f.options.offset.indexOf("%") > -1 && (d = Math.ceil(s.contextDimension * d / 100))), a = s.contextScroll - s.contextOffset, f.triggerPoint = w + a - d, h = y < s.oldScroll, p = f.triggerPoint >= s.oldScroll, u = h && p, c = !h && !p, !g && u ? (f.queueTrigger(s.backward), n[f.group.id] = f.group) : !g && c ? (f.queueTrigger(s.forward), n[f.group.id] = f.group) : g && s.oldScroll >= f.triggerPoint && (f.queueTrigger(s.forward), n[f.group.id] = f.group)
                    }
                }
    ...
    6: [function(require, module, exports) {
        "use-strict";
        require("./modules/adHeader.js");
        var d3 = require("d3"),
            queue = require("queue-async");
        require("../../node_modules/waypoints/lib/noframework.waypoints.min.js"), require("../../node_modules/waypoints/lib/shortcuts/inview.min.js");
        var chartFactory = require("./modules/multiline-chart.js"),
            gfx = {
                init: function() {
                    var e = this;
                    this.syncedCharts = [], this.likelihood = {
                        current: +d3.select("body").attr("data-bbg-likelihood-current"),
                        previous: +d3.select("body").attr("data-bbg-likelihood-previous"),
                        hidePrevious: d3.select("body").attr("data-bbg-likelihood-hide-previous")
                    }, this.rotateStar(), this.bisect = d3.bisector(function(e) {
                        return e.x
                    }).right, this.likelihoodChart(), this.pollTracker(), this.endCharts();
                    var t = !1;
                    new Waypoint.Inview({
                        element: document.getElementById("bbg-lkhd-bars-trigger"),
                        enter: function(a) {
                            t || (e.movelikelihoodChart(), t = !0)
                        }
                    });
                    if (~location.search.indexOf("phantom=") && e.movelikelihoodChart(), ~location.search.indexOf("phantom=tout")) {
                        var a = d3.selectAll(".bbg-section-wrapper").append("div").classed("bbg-tout-bottom-container", !0);
                        a.append("div").classed("bbg-tout-bottom", !0).html('<span>How likely is Brexit?</span> <span class="bbg-blue">See the graphic</span> <span class="bbg-icon"></span>')
                    }
                    d3.select(window).on("resize.gfx", state.set)
                },
                likelihoodChart: function() {
                    var e = d3.scale.linear().domain([0, 100]).range([0, 100]),
                        t = d3.select("#bbg-likelihood-container");
                    t.append("div").classed("bbg-arrow-zero", !0);
                    var a = t.append("div").classed("bbg-bulldogs-container", !0);
                    a.append("div").classed("bbg-bulldog-container", !0).attr("data-which", "eu"), a.append("div").classed("bbg-bulldog-container", !0).attr("data-which", "uk");
                    var n = t.append("div").classed("bbg-lkhd-bars-container", !0).attr("id", "bbg-lkhd-bars-trigger");
                    n.append("div").classed("bbg-likelihood-bar", !0).append("div").classed("bbg-likelihood-fill-bar", !0).style("width", function() {
                        return e(gfx.likelihood.previous) + "%"
                    });
                    var i = n.selectAll(".bbg-bar-tick-container").data([0, 50, 100]).enter().append("div").classed("bbg-bar-tick-container", !0).style("position", "absolute").attr("data-which", function(e) {
                        return "el-" + e
                    });
                    i.append("div").classed("bbg-bar-tick", !0), i.append("div").classed("bbg-bar-val", !0).html(function(e) {
                        return e + "%"
                    });
                    var s = n.append("div").classed("bbg-previous-lkhd-container", !0).style("left", function() {
                        return e(gfx.likelihood.previous) + "%"
                    }).style("display", function() {
                        return "true" == gfx.likelihood.hidePrevious ? "none" : null
                    });
                    s.append("div").classed("bbg-previous-lkhd-box", !0).html("PREVIOUS");
                    var o = t.append("div").classed("bbg-likelihood-value-container", !0);
                    o.append("div").classed("bbg-likelihood-value", !0).html(gfx.likelihood.current + "%"), o.append("div").classed("bbg-likelihood-value-label", !0).html("chance of Brexit"), t.append("div").attr("id", "bbg-lkhd-credit").html('Projection by Matt Singh of <a class="t-disable" href="http://ncpolitics.uk" target="_blank">www.ncpolitics.uk</a>'), this.d3_lkhdContainer = t, this.d3_prevBox = s, this.scale = e
                },
                movelikelihoodChart: function(e) {
                    var t = 300,
                        a = 3e3,
                        n = e ? 0 : this.scale(gfx.likelihood.current);
                    this.d3_lkhdContainer.select(".bbg-likelihood-fill-bar").style("width", n + "%"), 0 === gfx.likelihood.current && this.d3_lkhdContainer.select(".bbg-arrow-zero").style("opacity", 0).transition().delay(a + t).duration(t).style("opacity", 1)
                },
                pollTracker: function() {
                    var e = [{
                            name: "ncp_pop_remain",
                            tooltipName: "remain",
                            color: "#2800d7",
                            legendName: "Remain in the EU"
                        }, {
                            name: "ncp_pop_leave",
                            tooltipName: "leave",
                            color: "#fa1e64",
                            legendName: "Leave the EU"
                        }, {
                            name: "ncp_pop_undecided",
                            tooltipName: "undecided",
                            color: "#999",
                            legendName: "Undecided"
                        }],
                        t = chartFactory().seriesInfo(e).tooltipLabel("tooltipName").valueSuffix("%").xKey("x").yKey("y").tickValues([60, 40, 20, 0]).yRange([0, 60]).xAxisStyle("months").intervalSuffix(/_int$/).annotations([{
                            date: "2015-09-01",
                            text: "Referendum question set",
                            width: "100px"
                        }, {
                            date: "2015-11-11",
                            text: "Cameron outlines demands",
                            width: "120px"
                        }, {
                            date: "2015-12-17",
                            text: "First EU summit discussion; Cameron says he can get deal in Feb.",
                            width: "130px"
                        }, {
                            date: "2016-02-02",
                            text: "Tusk issues EU compromise plan",
                            width: "120px"
                        }, {
                            date: "2016-02-21",
                            text: "Deal agreed, Cameron announces referendum date",
                            width: "185px"
                        }, {
                            date: "2016-03-22",
                            text: "Brussels terrorist attack",
                            width: "185px"
                        }, {
                            date: "2016-06-23",
                            text: "Referendum",
                        ...
                        a = d3.select("#bbg-poll-tracker-legend"),
                        n = a.selectAll(".bbg-legend-el").data(e).enter().append("div").classed("bbg-legend-el", !0);
                    n.append("div").classed("bbg-legend-swatch", !0).style("background-color", function(e) {
                        return e.color
                    }), n.append("div").classed("bbg-legend-text", !0).html(function(e) {
                        return e.legendName
                    }), n = a.append("div").classed("bbg-legend-el", !0), n.append("div").classed("bbg-legend-swatch", !0).classed("bbg-legend-swatch-big", !0).style("background", "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAECAYAAABGM/VAAAAAGElEQVQImWOYOXPm/5kzZ/5nQAZYBYkGAP/WCylzl9mNAAAAAElFTkSuQmCC)"), n.append("div").classed("bbg-legend-text", !0).html("Margin of error");
                    var i = d3.select("#bbg-poll-tracker").datum(datasets.ds.polltracker).call(t);
                    state.is_mobile || i.on("mouseenter", this.toggleTooltipSync(!0, t)).on("mousemove", this.trackMouseSync(t)).on("mouseleave", this.toggleTooltipSync(!1)), this.syncedCharts.push(t)
                },
                endCharts: function() {
                    var e = d3.extent(datasets.ds.pound, function(e) {
                            return Math.floor(e.y)
                        }),
                        t = .5,
                        a = chartFactory().seriesInfo([{
                            name: "pound",
                            color: "#fa1e64"
                        }]).xKey("x").yKey("y").title("GBPUSD 6 Month 25 Delta Risk Reversal").xAxisStyle("months-years").tickValues(d3.range(e[0], e[1] + 2 * t, t).reverse()),
                        n = d3.select("#bbg-pound-value").datum([datasets.ds.pound]).call(a);
                    state.is_mobile || n.on("mouseenter", this.toggleTooltipSync(!0, a)).on("mousemove", this.trackMouseSync(a)).on("mouseleave", this.toggleTooltipSync(!1));
                    var i = chartFactory().seriesInfo([{
                            name: "spread",
                            color: "#2800d7"
                        }]).valuePrefix("Â£").xKey("x").yKey("y").xAxisStyle("months-years").tickValues([210, 190, 170, 150, 130]),
                        s = d3.select("#bbg-bond-spread").datum([datasets.ds.spread]).call(i);
                    state.is_mobile || s.on("mouseenter", this.toggleTooltipSync(!0, i)).on("mousemove", this.trackMouseSync(i)).on("mouseleave", this.toggleTooltipSync(!1)), this.syncedCharts.push(a), this.syncedCharts.push(i)
                },
                toggleTooltipSync: function(e, t) {
                    var a = this;
                    return function(n) {
                        a.syncedCharts.forEach(function(i) {
                            i.toggleTooltip(e), e && a.trackMouseSync.call(a, t).call(this, n)
                        }, this)
                    }
                },
                trackMouseSync: function(e) {
                    var t = this;
                    return function(a) {
                        var n = d3.mouse(this)[0],
                            i = e.calculateDFromMouseX(n, a[0]);
                        t.syncedCharts.forEach(function(e, t) {
                            e.fillTooltipAtDate(i.x)
                        })
                    }
                },
                rotateStar: function() {
                    var e = d3.select("#bbg-star-to-fall"),
                        t = e.attr("d").split("l")[0].replace("M", "");
                    e.transition("rotate").delay(1500).duration(1e3).ease("bounce-in").attrTween("transform", function(e) {
                        return function(e) {
                            return "rotate(" + -65 * e + "," + t + ")"
                        }
                    }).transition("fall").duration(500).delay(2500).ease("bounce-in").attrTween("transform", function(e) {
                        return function(e) {
                            return "rotate(-65," + t + ")translate(" + -24 * e + "," + 10 * e + ")"
                        }
                    })
                }
            },
            transformation = {
                init: function(e, t, a, n) {
                    return e && console.error(e), datasets.ds.pound = t.reverse(), datasets.ds.spread = a.reverse(), datasets.ds.polltracker = transformation.separatePollAnswers(n), datasets.cb(), this
                },
                separatePollAnswers: function(e) {
                    var t = {};
                    return e.forEach(function(e) {
                        Object.keys(e).filter(function(e) {
                            ...
                            var n = {};
                            t[a] || (t[a] = []), n.x = e.x, n.y = e[a], n.series = a, t[a].push(n)
                        })
                    }), _.values(t)
                }
            },
            datasets = {
                init: function(e) {
                    return this.cb = e, this.ds = {}, this.loadAll(transformation.init), this
                },
                loadAll: function(e) {
                    function t(e) {
                        var t = "date",
                        ...
                        return function(s) {
                            Object.keys(s).filter(function(e) {
                                ...
                                "polltracker" === e ? s[t] = +s[t] : (s.y = +s[t], delete s[t])
                            }), s.series = e;
                            var o = s[t] || s[n];
                            return s.x = a.parse(o), delete s[t], delete s[n], s
                        }
                    }
                    var a = d3.time.format("%Y-%m-%d");
                    return queue().defer(d3.csv, "data/pound.csv?" + (new Date).getTime(), t("pound")).defer(d3.csv, "data/spread.csv?" + (new Date).getTime(), t("spread")).defer(d3.csv, "data/polls.csv?" + (new Date).getTime(), t("polltracker")).await(e), this
                }
            },
            start = {
                go: function() {
                    return datasets.init(function() {
                        gfx.init()
                    }), this
                }
            },
            state = {
                set: function() {
                    this.is_mobile = state.isMobile()
                },
                isMobile: function() {
                    return "none" === d3.select("#bbg-is-mobile").style("display")
                }
            };
        state.set(), start.go();
    }, {
        "../../node_modules/waypoints/lib/noframework.waypoints.min.js": 4,
        "../../node_modules/waypoints/lib/shortcuts/inview.min.js": 5,
        "./modules/adHeader.js": 7,
        "./modules/multiline-chart.js": 8,
        "d3": 1,
        "queue-async": 2
    }],
    7: [function(require, module, exports) {
        ...
        d3.select(window).on("scroll.sticky", function() {
            var e = pageYOffset > 200;
            fixedHeader != e && (fixedHeader = e, d3.select(".bb-nav-root").classed("stuck", fixedHeader), d3.select("#full-header-space").classed("stuck", fixedHeader), bbNav.setAttribute("data-mode", fixedHeader ? "content" : "index"), fixedHeader && (bbNav.setAttribute("data-headline", d3.select("title").text()), bbNav.displaySocialButtons({
    ...
    8: [function(require, module, exports) {
        ...
        module.exports = function() {
            function t(t) {
                function e(t, e) {
                    i = this, n(i, t), r(i, t), c(i, t)
                }

                function a() {
                    d3.select(this).select(".bbg-chart-container").remove(), d3.select(this).select(".bbg-annotations-container").remove()
                }

                function o() {
                    state.set(), t.each(a), t.each(e)
                }
                ...
                function c(t, e) {
                    ...
                    if (e.forEach(function(t) {
                            var a, i;
                            if (O && O.test(t[0].series)) {
                                var a = e.filter(function(e) {
                                        return e[0].series == t[0].series.replace(O, "")
                                    })[0],
                                    i = t.map(function(t, e) {
                                        var n = {};
                                        return n[M] = t[M], n[B] = a[e][B], n.moe = t[B], n.series = t.series, n
                                    });
                                n.push(i)
                            } else r.push(t)
                        }), A = n.map(function(t) {
                ...
                function d(t) {
                    for (var e = [], n = d3.time.format("%Y-%m-%d"), r = t.length - 1; r >= 0; r--) {
                        var a = t[r];
                        a.dateStr = t[r].date, a.dateObject = n.parse(t[r].date), a.text = t[r].text, e.push(a)
                    }
                    return e
                }
                ...
                function f(e, n) {
                    function r(t, e) {
                        return t[e].parentNode.getBoundingClientRect()
                    }
                    var a = d3.select(e),
                        i = 45,
                        o = a.append("div").classed("bbg-annotations-container", !0).style("width", l + "px").style("margin-left", b.left + "px").style("position", "relative").selectAll(".bbg-annotation-container", !0).data(n).enter().append("div").attr("class", function(t, e) {
                            return e ? "" : "bbg-selected"
                        }).classed("bbg-annotation-container", !0).style("position", "absolute").style("top", "0").style("left", "0").style("z-index", function(t, e) {
                            return 99 + n.length - e
                        }).attr("data-orientation", function(t, e) {
                            return e ? state.is_mobile && t.dateObject > new Date(2016, 1, 1) ? "right" : "left" : "right"
                        }).style("transform", function(t) {
                            return "translateX(" + u(t.dateObject) + "px)"
                        }).style("width", function(t) {
                            return t.width
                        }).on("click", function() {
                            t.selectAll(".bbg-selected").classed("bbg-selected", !1), d3.select(this).classed("bbg-selected", !0)
                        }),
                        s = o.append("div").classed("bbg-annotation-a-container", !0),
                        c = s.append("div").classed("bbg-annotation-line-box", !0).style("position", "absolute").style("top", "0").style("left", "0"),
                        d = s.append("div").classed("bbg-annotation-text-container", !0);
                    d.append("div").classed("bbg-annotation-hed", !0).html(function(t) {
                        return j(t.dateObject)
                    }), d.append("div").classed("bbg-annotation-text", !0).html(function(t) {
                        return t.text
                    }), d.style("margin-top", function(t, e) {
                        var a, s, l = this.getBoundingClientRect(),
                            c = i,
                            u = 10,
                            d = o.selectAll(".bbg-annotation-container");
                        if (e && (a = r(d, e - 1), l.right > a.left && e < n.length - 1)) {
                            if (s = r(d, e + 1), !(l.left - l.width > s.right)) return 4 == e ? (d3.select(this.parentNode.parentNode).attr("data-orientation", "right"), s.height + c + u + "px") : a.height + u + "px";
                            d3.select(this.parentNode.parentNode).attr("data-orientation", "right")
                        }
                        return c + "px"
                    }), c.style("height", function(t) {
                        var e = d3.select(this.parentNode).select(".bbg-annotation-text-container").style("margin-top");
                        return e
                    })
                }

                function p(t) {
                    var e = s.selectAll(".bbg-line-series-g").data(t).enter().append("g").classed("bbg-line-series-g", !0).attr("data-which", function(t) {
                        return t[0].series
                    });
                    e.append("path").classed("bbg-line-series", !0).attr("d", function(t) {
                        return y(t)
                    }).style("fill", "none").style("stroke", function(t) {
                        return g(t[0].series)
                    }), e.append("circle").classed("bbg-hover-circle", !0).attr("r", "6").attr("data-show", "false").style("stroke", function(t) {
                        return g(t[0].series)
                    }).style("fill", "#fff")
                }

                function h(t) {
                    var e = s.selectAll(".bbg-area-series-g").data(t).enter().append("g").classed("bbg-area-series-g", !0).attr("data-which", function(t) {
                        return t[0].series
                    });
                    e.append("path").classed("bbg-area-series", !0).attr("d", function(t) {
                        return w(t)
                    }).style("fill", function(t) {
                        return "url(#pattern-" + t[0].series + ")"
                    }).style("stroke", "none")
                }
                var v = _.uniqueId("chart-");
                state.set(), t.each(e);
                var m = _.debounce(o, 200);
                d3.select(window).on("resize.chart." + v, m)
            }

            function e(t, e) {
                e.forEach(function(e, n) {
                    t.append("pattern").datum(e[0]).attr({
                        x: 1,
                        y: 1,
                        width: 4,
                        height: 4,
            ...
            function n(t, e) {
                ...
                l = r - b.left - b.right, c = a - b.top - b.bottom, x = d3.bisector(function(t) {
                    return t.x
                }).right, y = d3.svg.line().interpolate("cardinal").x(function(t) {
                    return u(t[M])
                }).y(function(t) {
                    return d(t[B])
                ...
                var i = d3.time.format("%Y-%m-%d");
                u = d3.time.scale().domain([i.parse("2015-09-01"), i.parse("2016-06-30")]).range([0, l]);
                var o = C || d3.extent(n, function(t) {
                        return t[B]
                    }),
                    s = o[0] < -1 ? -1 : 1;
                o[0] = o[0] - .1 * o[0] * s, d = d3.scale.linear().domain([o[0], o[1] + .25]).range([c, 0]), h = function() {
                    return d3.svg.axis().scale(d).orient("left").tickValues(R).tickFormat(function(t, e) {
                        if (0 > t) {
                            if (t = t.toFixed(1), !e) return t.toString().replace("-", "-" + q) + z
                        } else if (!e) return q + t + z;
                        return t + z
                    })
                }, v = function() {
                    function t(t) {
                        t.each(function(r) {
                            var a = e.ticks(6),
                                i = Math.ceil(e.range()[1] / a.length),
                                o = 20,
                                s = 2 * o,
                                l = "months" == n ? o : 10,
                                c = t.selectAll(".bbg-tick").data(a).enter().append("g").classed("bbg-tick", !0).attr("transform", function(t) {
                                    return "translate(" + (e(t) + i / 2 - b.right) + ", " + o + ")"
                                }).each(function(t, e) {
                                    e || d3.select(this).append("line").attr("transform", "translate(-" + (i / 2 - b.right) + ",-" + o + ")").attr("x2", 0).attr("y2", l)
                                });
                            c.append("line").attr("transform", function(t, e) {
                                var n = e == a.length - 1 ? 1 : 3;
                                return "translate(" + (i / 2 + n) + ",-" + o + ")"
                            }).attr("x2", 0).attr("y2", function(t) {
                                var e = Y(t).split(" ")[0];
                                return "Dec" == e ? s : l
                            }), c.append("text").attr("text-anchor", "end").attr("transform", function(t) {
                                var e = Y(t).split(" ")[0],
                                    n = "translate(15,0)";
                                return "Jan" == e || "Apr" == e || "Feb" == e ? n = "translate(12,0)" : "Mar" == e && (n = "translate(18,0)"), state.is_mobile && (n = "translate(8,0)"), n
                            }).attr("width", i).text(function(t) {
                                var e = Y(t).split(" ")[0];
                                return state.is_mobile && (e = e.charAt(0)), e
                            }), "months-years" == n && t.selectAll(".bbg-year-tick").data([new Date(2015, 9, 31), new Date(2016, 2, 31)]).enter().append("text").attr("text-anchor", "middle").attr("transform", function(t) {
                                return "translate(" + e(t) + "," + s + ")"
                            }).text(function(t) {
                ...
                }, f = v().scale(u).format(F), p = h(), g = d3.scale.ordinal().domain(_.pluck(S, "name")).range(_.pluck(S, "color"))
            }

            function r(t, n) {
                o = d3.select(t).append("div").classed("bbg-chart-container", !0), m && o.append("div").classed("bbg-chart-title", !0).html(m);
                var r = o.append("div").classed("bbg-tooltip", !0).style("position", "absolute").attr("data-show", "false"),
                    a = r.selectAll(".bbg-tooltip-value-row").data(n.filter(function(t) {
                        return O ? !O.test(t[0].series) : !0
                    })).enter().append("div").classed("bbg-tooltip-value-row", !0);
                a.append("div").classed("bbg-tooltip-value", !0).style("color", function(t) {
                    return g(t[0].series)
                }), N && a.append("div").classed("bbg-tooltip-value-label", !0), r.append("div").classed("bbg-tooltip-date", !0);
                var i = o.append("svg").attr("width", l + b.left + b.right).attr("height", c + b.top + b.bottom),
                    u = i.append("defs");
                O && e(u, n.filter(function(t) {
                    return O.test(t[0].series)
                })), s = i.append("g").attr("transform", "translate(" + b.left + "," + b.top + ")");
                var v = (s.append("g").attr("class", "bbg-x bbg-axis").attr("transform", function(t, e) {
                    return "translate(0," + d(R[R.length - 1]) + ")"
                }).call(f), s.append("g").attr("class", "bbg-y bbg-axis").attr("transform", "translate(0,0)").call(p));
                v.append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end"), s.append("g").attr("class", "bbg-grid").call(h().tickSize(-l, 0, 0).tickFormat(""))
            }
            ...
            var i, o, s, l, c, u, d, f, p, b, g, h, v, m, x, y, w, A, k, S, M, B, R, C, D, F, N, O, j = d3.time.format("%B %e"),
                Y = d3.time.format("%b %e, %Y"),
                q = "",
                z = "";
            return t.fillTooltipAtDate = function(t) {
                var e = d3.select(i),
                    n = e.datum().map(function(e) {
                        return d(a(t, e).y)
                    }),
                    r = d3.min(n),
                    o = a(t, e.datum()[0]),
                    ...
                    l = Math.round(s),
                    c = Math.round(r),
                    f = e.select(".bbg-tooltip").style("left", function() {
                        var t = l + b.left,
                            e = this.getBoundingClientRect().width / 2,
                            n = i.getBoundingClientRect(),
                            r = (n.left, n.right),
                            a = 5;
                        return a > t - e ? e + a + "px" : t + e > r - a ? r - e - a + "px" : t + "px"
                    }).style("top", c + "px");
                e.selectAll(".bbg-hover-circle").attr("cx", l).attr("cy", function(e) {
                    var n = a(t, e);
                    return d(n.y)
                });
                var p = d3.format("r", 2);
                f.selectAll(".bbg-tooltip-value").html(function(e, n) {
                    var r = a(t, e),
                        i = r.y;
                    return "pound" != S[n] && "spread" != S[n] && (i = Math.round(10 * i) / 10), p(i).toString().replace("-", "-" + q) + z
                }), f.selectAll(".bbg-tooltip-value-label").html(function(e, n) {
                    var r, i = "";
                    return O && (r = A.map(function(t) {
                        return t.replace(O, "")
                    }).indexOf(e[0].series), i = " (&#177;" + a(t, k[r]).moe + ")"), S[n][N] + i
                }), f.select(".bbg-tooltip-date").html(Y(o.x))
            }, t.calculateDFromMouseX = function(t, e) {
                var n = t - b.left;
                0 > n && (n = 0);
                var r = u.invert(n);
                return a(r, e)
                ...
                var n = d3.select(i);
                return n.selectAll(".bbg-tooltip,.bbg-hover-circle").attr("data-show", e.toString()), t
            }, t.seriesInfo = function(e) {
                return e ? (S = e, t) : S
            }, t.valuePrefix = function(e) {
                return e ? (q = e, t) : q
            }, t.xKey = function(e) {
                return e ? (M = e, t) : M
            }, t.yKey = function(e) {
                ...
                return e ? (q = e, t) : q
            }, t.valueSuffix = function(e) {
                return e ? (z = e, t) : z
            }, t.yRange = function(e) {
                return e ? (C = e, t) : C
            }, t.annotations = function(e) {
                return e ? (D = e, t) : D
            }, t.xAxisStyle = function(e) {
                return e ? (F = e, t) : F
            }, t.tooltipLabel = function(e) {
                return e ? (N = e, t) : N
            }, t.intervalSuffix = function(e) {
                return e ? (O = e, t) : O
            }, t.title = function(e) {
                return e ? (m = e, t) : m
            }, t
